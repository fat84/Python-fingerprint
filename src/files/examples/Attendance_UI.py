        ...
        if(self.isPassed == False):
            ...
            if (score != 0):
                ...
                if(manage_db.is_connected()):
                    statusResult = manage_db.clock_in(self.sectionlogId, self.clockInTime, self.userInfo[4])
                else:
                    statusResult = manage_db.clock_in_to_text(self.sectionlogId, self.clockInTime, self.userInfo[4])
